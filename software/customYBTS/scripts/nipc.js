...
function readConfiguration(return_subscribers)
{
    ...
    if (!sms_registration)
	sms_registration = "Welcome to USCRPL's Wireless Network. Your allocated phone no. is ${nr}. For assistance, call Arpad at (${arpad_number})";
...
function sendGreetingMessage(imsi, msisdn)
{
    ...
    var nrs = { "nr":msisdn, "arpad_number":"7852006" };
